...
#+BEGIN_SRC javascript :tangle solving-a-maze.js
  ...
  function search(maze, row, col, solved = false) {
      if (solved) { return [maze, solved] }
      if (maze[row][col] === 'G') {
  ...
  function main() {
      ...
      let maze = readMaze('input-maze-1.txt')
      console.log(maze)
